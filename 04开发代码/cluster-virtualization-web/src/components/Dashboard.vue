<template>
    <div class="dashboard columns">
        ...
        <div class="column">
            <Table id="table" v-bind:data="getCsv.data" v-bind:col-headers="getCsv.colHeaders"/>
